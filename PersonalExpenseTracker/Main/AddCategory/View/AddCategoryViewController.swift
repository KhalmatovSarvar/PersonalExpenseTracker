...
class AddCategoryViewController: UIViewController {
    ...
    let iconData: [String] = ["dollarsign.circle", "bag", "figure", "airplane.arrival", "car", "lightrail", "house", "bolt.badge.checkmark", "display.2", "airpodsmax", "mountain.2", "figure.bowling", "calendar.badge.checkmark", "person.2.wave.2",]
